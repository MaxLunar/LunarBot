...
def terminate():
    # Store all files and objects in variables/dictionary from global
    # namespace, to ensure visibility
    pass
...
def call(**kw):
    ...
    # Next unpacks is unnecessary for proper work and only here to show their
    # existence(decide it yourself)
